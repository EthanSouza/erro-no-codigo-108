...
def countFingers(image, hand_landmarks, handNo=0):
    ...
    if hand_landmarks:
        ...
        for lm_index in tipIds:
            ...
            #obter os valores de y da ponta e da parte inferior dos dedos
            finger_tip_y  = landmarks[lm_index].y
            finger_bottom_y = landmarks[lm_index -2].y
            
            #verificar se algum dedo está aberto ou fechado
            if lm_index != 4:
                if finger_tip_y < finger_bottom_y:
                    fingers.append(1)
                    print("Dedo com o id ", lm_index, "está aberto")

                if finger_tip_y > finger_bottom_y:
                    fingers.append(0)
                    print("Dedo com o id ", lm_index, "está fechado")
